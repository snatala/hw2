...
{
  Book* b = new Book(categoryID(), prodName_, price_, qty_, author_, isbn_); 
  return b;
}
...
{
  Clothing* c = new Clothing(categoryID(), prodName_, price_, qty_, size_, brand_);
  return c;
}
...
{
  Movie* m = new Movie(categoryID(), prodName_, price_, qty_, genre_, rating_);
  return m;
}
